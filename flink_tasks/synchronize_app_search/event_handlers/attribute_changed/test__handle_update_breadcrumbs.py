...
def test__handle_update_derived_entities_update_document() -> None:
    ...
    with patch(
        "flink_tasks.synchronize_app_search.event_handlers.attribute_changed.handle_update_breadcrumbs.get_documents",
...
def test__handle_update_breadcrumbs_malformed_breadcrumb() -> None:
    ...
    with patch(
        ...
        "flink_tasks.synchronize_app_search.event_handlers.attribute_changed.handle_update_breadcrumbs.logging.error",
    ) as mock_logger:
        updated_documents = handle_update_breadcrumbs(message, Mock(), "test_index")
