...
from .handle_update_derived_entities import (
...
def test__handle_update_derived_entities_update_document() -> None:
    ...
    with patch(
        "flink_tasks.synchronize_app_search.event_handlers.attribute_changed.handle_update_derived_entities.get_documents",
